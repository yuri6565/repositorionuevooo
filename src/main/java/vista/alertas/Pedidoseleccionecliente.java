...
public class Pedidoseleccionecliente extends JDialog {

    public Pedidoseleccionecliente(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Por favor, seleccione un cliente");
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        public static void main(String args[]) {
            try {
                ...
                java.util.logging.Logger.getLogger(Pedidoseleccionecliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            }

            java.awt.EventQueue.invokeLater(() -> {
                Pedidoseleccionecliente dialog = new Pedidoseleccionecliente(null, true);

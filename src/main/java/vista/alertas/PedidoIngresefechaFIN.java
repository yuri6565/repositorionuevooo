...
public class PedidoIngresefechaFIN extends JDialog {

    public PedidoIngresefechaFIN(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Por favor, seleccione la fecha de finalizacion");
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        public static void main(String args[]) {
            try {
                ...
                java.util.logging.Logger.getLogger(PedidoIngresefechaFIN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            }

            java.awt.EventQueue.invokeLater(() -> {
                PedidoIngresefechaFIN dialog = new PedidoIngresefechaFIN(null, true);

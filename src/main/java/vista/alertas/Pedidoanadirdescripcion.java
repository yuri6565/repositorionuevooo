...
public class Pedidoanadirdescripcion extends JDialog {

    public Pedidoanadirdescripcion(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Por favor, ingrese una descripcion");
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 130, 360, -1));
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        public static void main(String args[]) {
            try {
                ...
                java.util.logging.Logger.getLogger(Pedidoanadirdescripcion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            }

            java.awt.EventQueue.invokeLater(() -> {
                Pedidoanadirdescripcion dialog = new Pedidoanadirdescripcion(null, true);

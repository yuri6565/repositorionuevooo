...
public class MaterialingreseNombre extends JDialog {

    public MaterialingreseNombre(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        public static void main(String args[]) {
            try {
                ...
                java.util.logging.Logger.getLogger(MaterialingreseNombre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            }

            java.awt.EventQueue.invokeLater(() -> {
                MaterialingreseNombre dialog = new MaterialingreseNombre(null, true);

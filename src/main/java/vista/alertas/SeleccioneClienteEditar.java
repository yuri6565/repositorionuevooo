...
public class SeleccioneClienteEditar extends JDialog {

    public SeleccioneClienteEditar(Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Seleccione un cliente para editar");
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        public static void main(String args[]) {
            try {
                ...
                java.util.logging.Logger.getLogger(SeleccioneClienteEditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            }

            java.awt.EventQueue.invokeLater(() -> {
                SeleccioneClienteEditar dialog = new SeleccioneClienteEditar(null, true);
